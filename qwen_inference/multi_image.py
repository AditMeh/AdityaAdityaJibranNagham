...
image3 = Image.open("ball.png")

prompt = "The man is holding the soccer ball"
inputs = {
    "image": [image1, image3],
    "prompt": prompt,
...
with torch.inference_mode():
    ...
    output_image.save("output_image_edit_ball.png")
    print("image saved at", os.path.abspath("output_image_edit_ball.png"))